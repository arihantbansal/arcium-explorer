...
export const arxNodes = pgTable(
  "arx_nodes",
  {
    ...
    clusterOffset: integer("cluster_offset"),
    cuCapacityClaim: integer("cu_capacity_claim").notNull().default(0),
    isActive: boolean("is_active").notNull().default(false),
    blsPublicKey: varchar("bls_public_key", { length: 256 }),
...
export const computationDefinitions = pgTable(
  "computation_definitions",
  {
    ...
    address: varchar("address", { length: 64 }).notNull(),
    mxeProgramId: varchar("mxe_program_id", { length: 64 }).notNull(),
    defOffset: integer("def_offset").notNull(),
    cuAmount: integer("cu_amount").notNull().default(0),
    circuitLen: integer("circuit_len").notNull().default(0),
...
export const computations = pgTable(
  "computations",
  {
    ...
    clusterOffset: integer("cluster_offset").notNull(),
